...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.status'
        db.alter_column('vaquera_issue', 'status', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Issue.status'
        db.alter_column('vaquera_issue', 'status', self.gf('django.db.models.fields.CharField')(max_length=3))
