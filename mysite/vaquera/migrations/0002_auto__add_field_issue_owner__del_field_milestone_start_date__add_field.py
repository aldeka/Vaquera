...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('vaquera_issue', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_issue_set', null=True, to=orm['vaquera.Vaquerita']), keep_default=False)

        # Adding M2M table for field followers on 'Issue'
        db.create_table('vaquera_issue_followers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm['vaquera.issue'], null=False)),
            ('vaquerita', models.ForeignKey(orm['vaquera.vaquerita'], null=False))
        ))
        db.create_unique('vaquera_issue_followers', ['issue_id', 'vaquerita_id'])

        # Deleting field 'Milestone.start_date'
        db.delete_column('vaquera_milestone', 'start_date')

        # Adding field 'Milestone.description'
        db.add_column('vaquera_milestone', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'Milestone.end_date'
        db.alter_column('vaquera_milestone', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(1970, 1, 1)))


    def backwards(self, orm):
        
        # Deleting field 'Issue.owner'
        db.delete_column('vaquera_issue', 'owner_id')

        # Removing M2M table for field followers on 'Issue'
        db.delete_table('vaquera_issue_followers')

        # Adding field 'Milestone.start_date'
        db.add_column('vaquera_milestone', 'start_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(2011, 8, 17), blank=True), keep_default=False)

        # Deleting field 'Milestone.description'
        db.delete_column('vaquera_milestone', 'description')

        # Changing field 'Milestone.end_date'
        db.alter_column('vaquera_milestone', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))
